...
WidgetChrome.prototype.fill = function WC_fill() {
  ...
  var tbb = this._doc.createElement("toolbarbutton");
  tbb.setAttribute("label", this._widget.label);
  tbb.className = "toolbarbutton-1 sdk-customization-placeholder";
  this.node.appendChild(tbb);
